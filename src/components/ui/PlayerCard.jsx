...
function ClubBadge({ club }) {
  ...
  if (club.is_national) {
    ...
    return (
      <img src={`https://flagcdn.com/${code}.svg`} alt={club.name} className="h-5 w-7 flex-shrink-0 rounded-sm object-cover ring-1 ring-black/10" />
    )
  }
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              {flagCode && (
                <img src={`https://flagcdn.com/${flagCode}.svg`} alt={player.nationality}
                  className="h-3 w-[18px] flex-shrink-0 rounded-sm object-cover ring-1 ring-black/10" />
              )}
